...
project_root = Path(__file__).parent.parent.parent  # src/utils/ -> src/ -> miria-api/
data_dir = project_root / "data"

if not data_dir.exists():
    raise FileNotFoundError(f"Data directory not found at {data_dir}. Please create it.")
...
qc = QdrantClient(
    url="https://580750b2-da80-4488-9735-ae29ff0d6f90.us-west-2-0.aws.cloud.qdrant.io:6333",
    api_key="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhY2Nlc3MiOiJtIn0.wBgvFtCQ7ZHWy46a6McP2SHvQEIliXkBp7aue1qnJRI"
    )
aqc = AsyncQdrantClient(
    url="https://580750b2-da80-4488-9735-ae29ff0d6f90.us-west-2-0.aws.cloud.qdrant.io:6333",
    api_key="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhY2Nlc3MiOiJtIn0.wBgvFtCQ7ZHWy46a6McP2SHvQEIliXkBp7aue1qnJRI"
    )
