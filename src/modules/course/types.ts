...
export interface Course {
  ...
  generationSource?: "manual" | "from_completed_course" | "recommendation";
  derivationMode?: DerivedCourseMode;
...
export type DerivedCourseMode =
  | "deeper"
  | "adjacent"
  | "project-based"
  | "next-level";

export interface GenerateFromCourseRequest {
