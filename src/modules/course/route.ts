...
export class CourseRoute {
  ...
  private initializeRoutes(): void {
    ...
    this.router.get(
      "/courses/:id/next-actions",
      authMiddleware,
      validateCourseId,
      this.controller.getPostCompletionActions.bind(this.controller),
    );

    this.router.post(
      "/courses/generate-from-course/:id",
      authMiddleware,
      validateCourseId,
      validateGenerateFromCourse,
      this.controller.generateFromCourse.bind(this.controller),
    );
